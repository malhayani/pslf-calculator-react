...
import YearPlanInfoForm from '../YearPlanInfoForm';
import PaymentEstimates from '../PaymentEstimates';
...
const PslfCalculator = () => {
    ...
    const generateRepaymentSchedule = (totalLoanData, paymentsData) => {
        // STANDARD
    ...
    const calculateAssumptions = () => {
        ...
        let paymentsData = generatePayments(currentInfo, totalLoanData, formattedYearInfo);
        let repaymentSchedulesData = generateRepaymentSchedule(totalLoanData, paymentsData);
    ...
    return (
        <div className="pslf-calculator">
            ...
            { formDialogue.yearPlanInformation.toString() === 'true' 
                ? <CardContainter 
                    title="Student Loan Payment Estimates" 
                    ...
                    backText="Start Over">
                    <PaymentEstimates repaymentSchedules={loanPaymentData.repaymentSchedules} payments={loanPaymentData.payments} isMarried={personalInfo.isMarried}/>
                </CardContainter>
                : "" 
            }
            <br/>
